...
Route::group(['prefix' => 'api/v1'], function () use ($controller) {
    Route::get('projects/{projects}/checklists',  "$controller@index");
...
Route::group(['middleware' => ['csrftoken']], function () use ($controller) {
    ...
    Route::get('projects/{projects}/checklists', "$controller@index")->name('projects.checklists.index');
    ...
    Route::get('projects/{projects}/checklists/{checklists}', "$controller@show")->name('projects.checklists.show');
});
